...
- [`mixedsubjects`: An `R` package for estimating causal effects in social science experiements with a mixed subjects design](https://klintkanopka.com/mixedsubjects/)
- [`mixedsubjectsirt`: An `R` package for doing psychometric calibrations with a mixed subjects design](https://klintkanopka.com/mixedsubjectsirt/)
